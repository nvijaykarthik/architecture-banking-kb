# C4-10 Cloud Platform Model — BRIEF
...
graph TD
    ...
    A[Cloud Platform]:::critical --> B[Platform Team]:::core
    A --> C[Services]:::context
    A --> D[Cloud Providers]:::context
```
```
...
## Status
☐ Not started · See detail doc: `details/C4-10-cloud-platform-model.md`
